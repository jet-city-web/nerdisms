  ...
  return (
    <>
      ...
      <main>
        ...
        <blockquote><strong>10%</strong> will go the <Link href="https://www.codefellows.org/scholarship-fund/">Code Fellows Diversity Scholarship Fund</Link>, which targets diverse career changers with the funds they need to get started in the field of computer programming </blockquote>

        <blockquote><strong>10%</strong> will go <Link href="https://www.charitywater.org/">Charity Water</Link>, which has as it's mission to bring clean water to everyone on the planet</blockquote>

        <blockquote><strong>10%</strong> will go to a rotating set of organizations that focus on a range of services from education, assisting single parents, providing food, and whatever bubbles up as the most pressing need</blockquote>
